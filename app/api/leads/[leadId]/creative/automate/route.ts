...
export async function POST(
  ...
  try {
    ...
    if (forceRegenerate && hasGeneratingScenes) {
      return NextResponse.json(
        {
          error:
            "This lead is already being generated by the Higgsfield worker. Wait for it to finish before rebuilding the cinematic brief.",
        },
        { status: 409 }
      );
    }
